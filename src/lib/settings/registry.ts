...
export const SETTINGS_TILES: SettingsTile[] = [
  ...
  },
  {
    ...
    desc: "Which rails onboard a customer, which details you collect, and what joining costs.",
    icon: Users2,
    group: "Your platform",
    right: "settings.view",
  },
  {
    ...
    desc: "Every document you may ask for, and where each one is asked.",
    icon: Paperclip,
    group: "Your platform",
    right: "settings.view",
  },
  {
    ...
    desc: "The fields we did not ship that you need — on customers, loans, guarantors.",
    icon: ListPlus,
    group: "Your platform",
    right: "settings.view",
  },
  {
    ...
    title: "Loan settings",
    desc: "Restructures, top-ups, waivers, write-offs, penalties, arrears buckets, payouts.",
    icon: Landmark,
    group: "Your platform",
    right: "settings.view",
  },
