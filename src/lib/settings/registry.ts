...
export const SETTINGS_TILES: SettingsTile[] = [
  ...
  },
  {
    ...
    blurb: "Your own bureau subscription. Checks run only against a borrower's recorded consent, and every pull is logged against the application that justified it.",
    icon: Gauge,
    group: "Identity & risk",
    right: "settings.manage",
    fields: [
      ...
      { key: "endpoint", label: "Endpoint (optional)", wide: true },
    ],
  },
  {
    id: "servicesuite",
