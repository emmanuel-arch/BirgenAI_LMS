...
import {
  ...
  GitBranch, Palette, Settings2, KeyRound, Crown, Bot, Ticket, Mail, Ruler, Circle, type LucideIcon,
} from "lucide-react";
...
const ICONS: Record<string, LucideIcon> = {
  ...
  FilePlus2, Banknote, Wallet, HandCoins, Scale, PhoneCall, CalendarClock, BrainCircuit,
  SlidersHorizontal, ScanLine, FileBarChart, MapPin, MessageSquare, Building2, Package,
  GitBranch, Palette, Settings2, KeyRound, Crown, Bot, Ticket, Mail, Ruler,
};
