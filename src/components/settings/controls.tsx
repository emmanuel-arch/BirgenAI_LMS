...
export const INPUT =
  "mt-1 w-full rounded-lg border border-[color:var(--ink)]/12 bg-paper px-3 py-2.5 text-sm outline-none focus:border-transparent focus:ring-2 focus:ring-[color:var(--brand)]";
...
export function Toggle({
  ...
  return (
    ...
    >
      ...
      >
        <span className={`inline-block h-4 w-4 transform rounded-full bg-paper shadow transition-transform ${checked ? "translate-x-[1.15rem]" : "translate-x-0.5"}`} />
      </button>
    </label>
  );
}
